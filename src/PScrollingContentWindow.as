package  
{
	...
	public class PScrollingContentWindow extends PWindow
	{
		...
		public function PScrollingContentWindow(xDim:int = 300, yDim:int = 300, title:String = "", text:String = "", onAgree:Function = null, onCancel:Function = null) 
		{
			...
			if (notification)
			{
				notification.y = titleField.y + titleField.height ;
				...
				scrollUp.graphics.drawRoundRectComplex(notification.x+5, notification.y, notification.width-10, 20,5,5,0,0);
				...
				scrollDown.graphics.drawRoundRectComplex(notification.x+5, notification.y + tempSprite.height-20, notification.width-10, 20,0,0,5,5);
